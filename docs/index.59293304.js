 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new nh(nu.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new nc;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new o0({next:n=>{s.eu(),t.enqueueAndForget(()=>ov(e,o)),n.fromCache&&"server"===r.source?i.reject(new nh(nu.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),o=new o_(n,s,{includeMetadataChanges:!0,ua:!0});return oy(e,o)})(await o8(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new aq(t,r,e,n)))}(au(lv,"todos"))}function lI(e,t){let n=document.createElement("li");n.id=e,n.textContent=t,n.tabIndex=0,lb.appendChild(n)}async function lS(){let e=await function(e){e=ar(e,aa);let t=ar(e.firestore,af);return(function(e,t,n={}){let r=new nc;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new o0({next:a=>{s.eu(),t.enqueueAndForget(()=>ov(e,o));let l=a.docs.has(n);!l&&a.fromCache?i.reject(new nh(nu.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&a.fromCache&&r&&"server"===r.source?i.reject(new nh(nu.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new o_(new rO(n.path),s,{includeMetadataChanges:!0,ua:!0});return oy(e,o)})(await o8(e),e.asyncQueue,t,n,r)),r.promise})(ad(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new az(e);return new aj(e,i,t._key,r,new aV(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}(ah(lv,"apikey","googlegenai"));e.exists()?model=(genAI=new lg(apiKey=e.data().key)).getGenerativeModel({model:"gemini-1.5-flash"}):console.error("No API key found in Firestore")}async function lA(e){if(!model){console.error("Generative model is not initialized. Ensure getApiKey() runs first."),lx("AI is not available right now. Please try again later.");return}try{let t=await model.generateContent(e);lx(t.text())}catch(e){console.error("AI request failed:",e),lx("AI response failed. Please try again.")}}function lx(e){let t=document.createElement("div");t.textContent=e,t.className="history",chatHistory.appendChild(t),aiInput.value=""}window.addEventListener("load",()=>{l_()}),lE.addEventListener("click",async()=>{let e=lw.value.trim();if(e){let t=await lT(e);lw.value="",lI(t,e)}else alert("Please enter a task!")}),lb.addEventListener("click",async e=>{"LI"===e.target.tagName&&(await aG(ah(lv,"todos",e.target.id),{completed:!0}),e.target.remove())}),lw.addEventListener("keypress",function(e){"Enter"===e.key&&lE.click()}),lb.addEventListener("keypress",async function(e){"LI"===e.target.tagName&&"Enter"===e.key&&await aG(ah(lv,"todos",e.target.id),{completed:!0}),l_()}),window.addEventListener("load",async()=>{await lS(),l_()}),document.getElementById("send-btn").addEventListener("click",async()=>{let e=aiInput.value.trim().toLowerCase();e?!function(e){if(e.startsWith("add task")){let t=e.replace("add task","").trim();return t?(addTask(t),lx("Task "+t+" added!")):lx("Please specify a task to add."),!0}if(e.startsWith("complete")){let t,n=e.replace("complete","").trim();return n?0!=(t=document.getElementsByName(n)).length&&(t.forEach(e=>{removeTask(e.id),removeVisualTask(e.id)}),1)?lx("Task "+n+" marked as complete."):lx("Task not found!"):lx("Please specify a task to complete."),!0}return!1}(e)&&lA(e):lx("Please enter a prompt")}),window.addEventListener("error",function(e){console.error("Error occurred: ",e.message)});
//# sourceMappingURL=index.59293304.js.map
